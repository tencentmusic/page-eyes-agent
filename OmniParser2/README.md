...
## OCR 处理主类
```python
# .venv/lib/python3.12/site-packages/paddlex/inference/pipelines/ocr/pipeline.py
# _OCRPipeline
import paddlex.inference.pipelines.ocr.pipeline
```

## YOLO 目标检测
默认参数 `./site-packages/ultralytics/cfg/default.yaml`
```yaml
