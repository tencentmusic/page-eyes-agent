...
即使小参数的 LLM 也能胜任路径规划能力，同时支持多平台（Web、Android、HarmonyOS、iOS、Electron 桌面应用）
...
- :material-devices:{ .lg .icon-color } **[跨平台支持](getting-started/installation.md)**  
  支持 Web、Android、iOS、HarmonyOS、Electron 桌面应用。
  { .card .shadow .indigo }
...
- :material-devices:{ .lg } **强大的跨平台能力**  
  同一套指令适用于 Web、Android、HarmonyOS、iOS、Electron
  { .card .shadow }
